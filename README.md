...
|---|---|---|
| `C/` | Various animations, movement detection, and pose/hand recognition on Jetson Nano. Includes snake and brick pong games implemented in C/C++. | <ul><li>[🎬 Event-Driven Architecture](https://youtu.be/yVfnhKhP8lg)</li><li>[🧱 Brick Pong](https://drive.google.com/file/d/15immDvVE9rzHjOSAga4jwyM3pBoCWAVq/view?usp=sharing)</li><li>[🐍 Snake](https://drive.google.com/file/d/13E9lRFCfXW6GLsjpQeqEjfcrZtrPX8RK/view?usp=sharing)</li></ul> |
